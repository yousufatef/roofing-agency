...
const NavBar = () => {
  ...
  return (
    <div className="header">
      ...
      <div
        id="above-nav"
        className="grid grid-cols-3 justify-around text-center py-3 bg-red-600 text-white opacity-[0.9] max-md:hidden"
      >
        <div>
          <p>+201115737646</p>
        </div>
      ...
      <div
        id="nav"
        className="grid grid-cols-3 justify-around text-center py-4 bg-blue-500"
      >
        ...
        <ul
          id="list"
          className="flex justify-center max-md:bg-red-500 text-white max-md:flex max-md:flex-col max-md:mb-5 max-md:absolute max-md:item-center max-md:bg-white max-md:w-full max-md:left-0 max-md:top-0 max-md:py-5 max-md:hidden"
        >
