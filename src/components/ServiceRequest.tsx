const ServiceRequest = () => {
  return (
    <div className="bg-gray-300 flex w-[95%] min-h-[130px] m-auto  max-lg:flex-col">
        ...
        <div className="flex text-center flex-1 justify-center items-center pr-2 max-sm:flex-col mb-5">
            ...
            <button type="button" onClick={()=>  location.reload()} className="m-1 p-1 w-[80px] h-[30px] bg-mainColor hover:opacity-[0.9] text-white text-center outline-none max-sm:w-[90%] rounded">SEND</button>
        </div>
    </div>
  )
}
